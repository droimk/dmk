...
####droi huangjun add @2015.09.14##################################################
include droi_src/build/droi_replace_mk.mk
#end
...
####droi huangjun add @2015.09.14##################################################
-include droi_src/build/droi-core.mk
#end
...
####droi huangjun modify @2015.09.14##################################################
subdir_makefiles := \
	$(shell build/tools/findleaves.py --prune=$(OUT_DIR) --prune=.repo --prune=.git --prune=droi_src $(subdirs)  Android.mk)
####end
